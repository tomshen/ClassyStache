...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "ClassyStache"
 
        #Project url
        self.project_url = "http://www.tomzshen.com/ClassyStache"
        ...
        #Auhor of program
        self.author_name = "Tom Shen & Taylor Poulos"
        self.author_email = "tomshen@cmu.edu"
        self.copyright = "Copyright (c) 2012 Tom Shen & Taylor Poulos"
 
        #Description
        self.project_description = "The classiest game ever."
 
        #Icon file (None will use pygame default icon)
        self.icon_file = os.path.join('images', 'Icon.ico')
        ...
        self.extra_modules = []
        self.exclude_modules = ['django', 'numpy', 'scipy']
